...
inline HLSPRITE SPR_Height( HLSPRITE x, int f )	{ return gEngfuncs.pfnSPR_Height( x, f ); }
inline HLSPRITE SPR_Width( HLSPRITE x, int f )	{ return gEngfuncs.pfnSPR_Width( x, f ); }
