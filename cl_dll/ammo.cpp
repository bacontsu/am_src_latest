...
DECLARE_MESSAGE(m_Ammo, AllowWepSw);
...
{
	if ( gHUD.m_fPlayerDead || !m_bAllowWeaponSwitch )
		return;
...
int CHudAmmo::MsgFunc_CurWeapon(const char *pszName, int iSize, void *pbuf )
{
	...
	pWeapon->mods = mods;
	pWeapon->availableMods = allowedmods;
...
int CHudAmmo::MsgFunc_AllowWepSw( const char *pszName, int iSize, void *pbuf )
{
	BEGIN_READ( pbuf, iSize );
