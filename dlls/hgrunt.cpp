...
void CHGrunt :: Shotgun ( void )
{
	...
	FireBullets(gSkillData.hgruntShotgunPellets, vecShootOrigin, vecShootDir, VECTOR_CONE_15DEGREES, 2048, BULLET_PLAYER_SPAS12, 0 ); // shoot +-7.5 degrees
...
void CHGrunt :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	...
	switch( pEvent->event )
	{
		case HGRUNT_AE_DROP_GUN:
			...
			if (FBitSet( pev->weapons, HGRUNT_SHOTGUN ))
			{
				 DropItem( "weapon_spas12", vecGunPos, vecGunAngles );
			}
			else
			{
