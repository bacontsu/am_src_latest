...
public:
	...
	/* COLOR CORRECTION */
	void	setColorCorrection(float r, float g, float b, float s, float t, bool fromEnt);
	int _r, _g, _b, _s;
	float _t;
	/* *************** */
...
//	virtual void Think( void );
	...
	float client_blurAlpha;
	float client_blurStrength;
	float m_fHurted;
	...
	// Shepard : FMOD stuff
	BOOL m_bMusicIsAction;
	BOOL m_bMusicIsAllowedToSwitchToAction;
	float m_flMusicBackToStealthTime;
	float m_flMusicInitTime;
	void PlayActionMusic( void );
	int m_iLastReverberationType;

	// Shepard : Sprint stuff
	float m_flNextSprintSoundUpdate;
	float m_flNextStaminaUpdate;
	float m_flPlayerClientSpeed;
	float m_flPlayerSpeed;
	float m_flStaminaOut;
	...
	void EpipenPrepare( void );
	void EpipenThink( void );
	float m_flEpipenTime;

	void GrenadePrepare( void );
	void GrenadeThink( void );
	float m_flGrenadeTime;

	const char* Loot(const char *szEnemyType);
